...
type Port[Req any, Resp any] func(ctx context.Context, request Req) (response Resp, err error)

// Middleware is a chainable behavior modifier for the ports.
type Middleware[Req any, Resp any] func(next Port[Req, Resp]) Port[Req, Resp]
